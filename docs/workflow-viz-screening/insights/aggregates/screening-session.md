...
![架构总览图](../../charts/src-server-domain-screening-aggregates-screening-session-ts-544206ab-architecture-context.svg)
...
![模块拆解图](../../charts/src-server-domain-screening-aggregates-screening-session-ts-544206ab-architecture-modules.svg)
...
![依赖职责图](../../charts/src-server-domain-screening-aggregates-screening-session-ts-544206ab-architecture-dependencies.svg)
...
![主流程活动图](../../charts/src-server-domain-screening-aggregates-screening-session-ts-544206ab-activity.svg)
...
![协作顺序图](../../charts/src-server-domain-screening-aggregates-screening-session-ts-544206ab-sequence.svg)
...
![异步/并发图](../../charts/src-server-domain-screening-aggregates-screening-session-ts-544206ab-async-concurrency.svg)
...
![数据/依赖流图](../../charts/src-server-domain-screening-aggregates-screening-session-ts-544206ab-data-flow.svg)
