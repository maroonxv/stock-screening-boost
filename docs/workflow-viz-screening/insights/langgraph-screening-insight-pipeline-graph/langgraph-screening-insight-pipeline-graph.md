...
![架构总览图](../../charts/src-server-infrastructure-workflow-langgraph-screening-insight-pipeline-graph-ts-beca20df-architecture-context.svg)
...
![模块拆解图](../../charts/src-server-infrastructure-workflow-langgraph-screening-insight-pipeline-graph-ts-beca20df-architecture-modules.svg)
...
![依赖职责图](../../charts/src-server-infrastructure-workflow-langgraph-screening-insight-pipeline-graph-ts-beca20df-architecture-dependencies.svg)
...
![主流程活动图](../../charts/src-server-infrastructure-workflow-langgraph-screening-insight-pipeline-graph-ts-beca20df-activity.svg)
...
![协作顺序图](../../charts/src-server-infrastructure-workflow-langgraph-screening-insight-pipeline-graph-ts-beca20df-sequence.svg)
...
![分支判定图](../../charts/src-server-infrastructure-workflow-langgraph-screening-insight-pipeline-graph-ts-beca20df-branch-decision.svg)
...
![状态图](../../charts/src-server-infrastructure-workflow-langgraph-screening-insight-pipeline-graph-ts-beca20df-state.svg)
...
![异步/并发图](../../charts/src-server-infrastructure-workflow-langgraph-screening-insight-pipeline-graph-ts-beca20df-async-concurrency.svg)
...
![数据/依赖流图](../../charts/src-server-infrastructure-workflow-langgraph-screening-insight-pipeline-graph-ts-beca20df-data-flow.svg)
