...
![架构总览图](../../charts/src-server-domain-screening-services-scoring-service-ts-eb9b24c6-architecture-context.svg)
...
![模块拆解图](../../charts/src-server-domain-screening-services-scoring-service-ts-eb9b24c6-architecture-modules.svg)
...
![依赖职责图](../../charts/src-server-domain-screening-services-scoring-service-ts-eb9b24c6-architecture-dependencies.svg)
...
![主流程活动图](../../charts/src-server-domain-screening-services-scoring-service-ts-eb9b24c6-activity.svg)
...
![协作顺序图](../../charts/src-server-domain-screening-services-scoring-service-ts-eb9b24c6-sequence.svg)
...
![分支判定图](../../charts/src-server-domain-screening-services-scoring-service-ts-eb9b24c6-branch-decision.svg)
...
![异步/并发图](../../charts/src-server-domain-screening-services-scoring-service-ts-eb9b24c6-async-concurrency.svg)
...
![数据/依赖流图](../../charts/src-server-domain-screening-services-scoring-service-ts-eb9b24c6-data-flow.svg)
