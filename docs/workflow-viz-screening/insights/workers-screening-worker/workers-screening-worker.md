# 热点洞察：screening-worker.ts

- 源文件: `tooling/workers/screening-worker.ts`
- 热点分数: `65`
- 主入口: `main`
- 触发原因: `主编排函数存在 >= 5 个顺序步骤 (main calls=7)；异步/并发模式极强（类别数=4，且存在协调控制）`
...
![架构总览图](../../charts/tooling-workers-screening-worker-ts-31f88fd1-architecture-context.svg)
...
![模块拆解图](../../charts/tooling-workers-screening-worker-ts-31f88fd1-architecture-modules.svg)
...
![依赖职责图](../../charts/tooling-workers-screening-worker-ts-31f88fd1-architecture-dependencies.svg)
...
![主流程活动图](../../charts/tooling-workers-screening-worker-ts-31f88fd1-activity.svg)
...
![协作顺序图](../../charts/tooling-workers-screening-worker-ts-31f88fd1-sequence.svg)
...
![分支判定图](../../charts/tooling-workers-screening-worker-ts-31f88fd1-branch-decision.svg)
...
![异步/并发图](../../charts/tooling-workers-screening-worker-ts-31f88fd1-async-concurrency.svg)
