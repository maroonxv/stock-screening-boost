...
import type { InsightDataClient } from "~/modules/research/server/application/intelligence/insight-archive-service";
import {
...
} from "~/modules/research/server/application/intelligence/insight-synthesis-service";
...
} from "~/modules/research/server/workflows/langgraph/workflow-graph-base";
import {
  addResumeStart,
  addWorkflowNodes,
...
> {
  ...
  protected getNodeRoute(
    ...
    status: import("~/modules/research/server/domain/workflow/flow-spec").NodeResultStatus,
  ) {
