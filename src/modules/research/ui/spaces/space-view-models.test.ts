...
import type { ResearchSpaceRunLink } from "~/modules/research/contracts/space";
import {
...
describe("buildSpaceActionLinks", () => {
  it("prefills the four workflow entry points from the space brief and linked targets", () => {
    ...
    expect(links.industryResearchHref).toContain("/research?");
    ...
    expect(links.companyResearchHref).toContain("/research/company?");
