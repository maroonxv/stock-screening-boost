...
import { TimingReportChart } from "~/modules/timing/ui/reports/[cardId]/timing-report-chart";
import {
...
import { EmptyState, Panel, StatusPill } from "~/shared/ui/primitives/ui";
...
> = [
  ...
  },
  {
    id: "evidence",
    label: "结构证据",
    summary: "拆开价格结构与六大证据引擎，回答为什么当前偏这个方向。",
  },
  {
    id: "execution",
    label: "执行风控",
