...
export class UnsupportedIndicatorError extends Error {
  constructor(indicator: string) {
    super(`指标 ${indicator} 当前尚未接入可用数据源`);
    this.name = "UnsupportedIndicatorError";
    Object.setPrototypeOf(this, UnsupportedIndicatorError.prototype);
  }
}
 ...
 * 没有可筛选候选股票异常
 */
export class NoCandidateStocksError extends Error {
  constructor() {
    super("当前数据源没有返回可筛选的候选股票");
    this.name = "NoCandidateStocksError";
    Object.setPrototypeOf(this, NoCandidateStocksError.prototype);
  }
}
